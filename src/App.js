...
const miniGameCards = [
  ...
  { id: 8, 
    ...
    description: "Start with one batter and one pitcher for each team about 6ft apart. The batter takes three sips then three spins around the bat. The pitcher then throws an empty can and the batter tries to hit it. Keep trying until the batter hits the can. Once the batter hits the can they retrieve the can and become the pitcher. The next batter in line sips three times and spins three times. First team to have everyone hit the can wins.", 
    darts: false, 
    dartBoard: false, 
    soloCups: false, 
    pongBalls: false, 
